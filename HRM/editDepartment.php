                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-sitemap"></i>&nbsp; Departments</strong>
                        </div>
                        <div class="card-body">
...
if(!$department->count()) {
    ...
    foreach ($department->results() as $department) {
        ...
        echo "</td>";
        echo "<td>";
        echo "<a href='editDepartmentProceed.php?id=$department->depId' class='btn btn-outline-success btn-sm'><i class='fa fa-edit (alias)'></i>&nbsp; Edit</a>";
        echo "</td>";
        echo "</tr>";
    }
}
