...
class pdf extends TCPDF
{
	...
	public function Header(){
		...
		$this->Ln(2);
		$this->SetFont('helvetica', 'B', 15);
		$this->Cell(189,15, 'Report of New Arrivals', 0,1,'C');
		$this->Ln(10);

		$this->SetFont('times','B',9);
		$this->SetFillColor(224,235,255);
		$this->Cell(68,5,'Item Name',1,0,'C',1);
		$this->Cell(15,5,'Quantity',1,0,'C',1);
		$this->Cell(25,5,'Measuring Unit',1,0,'C',1);
		$this->Cell(20,5,'Arrived Date',1,0,'C',1);
		...
		$dep = DB::getInstance()->query("SELECT * FROM inv_arrivals WHERE supply_date BETWEEN '$sdate' AND '$edate'");
		...
		$this->Cell(50,5,'Report of Arrivals between',0,0,'C');
