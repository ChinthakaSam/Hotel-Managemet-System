...
<?php
$department = DB::getInstance()->query("SELECT * FROM personaldocument");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-sitemap"></i>&nbsp; Documents</strong>
                        </div>
                        <div class="card-body">
...
if(!$department->count()) {
    ...
    foreach ($department->results() as $department) {
        echo "<tr>";
        echo "<td>";
            echo $department->docId;
        echo "</td>";
        echo "<td>";
            echo $department->attachment;
        echo "</td>";
         echo "<td>";
            echo $department->empId;
        echo "</td>";
        echo "<td>";
            echo $department->docType;
        echo "</td>";
        echo "<td>";
         echo "<a href='deleteDocumentsProceed.php?id=$department->docId' class='btn btn-outline-danger btn-sm'><i class='fa fa-trash-o'></i>&nbsp; Delete</a>";
        echo "</td>";
        echo "</tr>";
    }
}
