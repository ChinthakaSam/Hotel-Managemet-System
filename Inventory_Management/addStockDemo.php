    ...
    <div id="right-panel" class="right-panel">
     ...
     <div class="breadcrumbs">
        ...
        <?php
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='date' id='expiry_date' name='expiry_date' value='' class='form-control'><small class='form-text text-muted'>If it is a non-food item or non-chemical you can ignore this field</small></div></div>"; 
