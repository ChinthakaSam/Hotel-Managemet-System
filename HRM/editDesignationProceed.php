...
<body>
    ...
    <?php
          ...
          $id = Input::get('id');
                ...
                $designation = DB::getInstance()->query("SELECT * FROM designation WHERE desId ='$id'");
                if(!$designation->count()) {
                                
                             } else {
                                foreach ($designation->results() as $designation) {
                  
                                    $di = $designation->desId;
                                    $dn = $designation->desName;
                                    $dbs = $designation->basicSalary;
                                    $dsi = $designation->salaryIncrement;
                                    $dscp = $designation->serviceChargePercentage;
                                    $dba = $designation->bonusAmount;
                                    $dmai = $designation->medAndInsAmount;
                                    ...
                                    echo "<td><input type='text' id='dbsal' name='dbsal' value='";
                                    echo $dbs;
                                    echo ".00'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Salary Increment</td>";
                                    echo "<td><input type='text' id='dsinc' name='dsinc' value='";
                                    echo $dsi;
                                    echo ".00'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Service Charge Percentage</td>";
                                    echo "<td><input type='text' id='dscper' name='dscper' value='";
                                    echo $dscp;
                                    echo "'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Bonus Amount</td>";
                                    echo "<td><input type='text' id='dbamt' name='dbamt' value='";
                                    echo $dba;
                                    echo "'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Medical And Insuarance Amount</td>";
                                    echo "<td><input type='text' id='dmains' name='dmains' value='";
                                    echo $dmai;
                                    echo ".00'/></td>";
                                    echo "</tr>";
                                    echo "</table>";   
    ...
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            //change password
             ...
             $dbsal = (double)Input::get('dbsal');
             $dsinc = (double)Input::get('dsinc');
             $dscper = (double)Input::get('dscper');
             $dbamt = (double)Input::get('dbamt');
             $dmains = (double)Input::get('dmains');

             $designationup = DB::getInstance()->query("UPDATE designation SET desName='$dname', 
                basicSalary = $dbsal,
                salaryIncrement = $dsinc,
                serviceChargePercentage = $dscper,
                bonusAmount = $dbamt,
                medAndInsAmount = $dmains
                WHERE desId ='$did'");
