...
<body>
    ...
    <?php
          ...
          $id = Input::get('id');
                ...
                $empdetail = DB::getInstance()->query("SELECT * FROM employee WHERE empId ='$id'");
                if(!$empdetail->count()) {
                                
                             } else {
                                foreach ($empdetail->results() as $empdetail) {
                  
                                    $ei = $empdetail->empId;
                                    $et = $empdetail->title;
                                    $enwi = $empdetail->nameWithInitials;
                                   
                                    $efn = $empdetail->fullName;
                                    $ecn = $empdetail->callName;
                                    $enic = $empdetail->nic;
                                    
                                    $edob = $empdetail->dob;
                                    $ecs = $empdetail->civilStatus;
                                    $ed = $empdetail->district;

                                    $egd = $empdetail->gsDivision;
                                    $ept = $empdetail->payType;
                                    $emn = $empdetail->mobileNo;
                                   
                                    $ern = $empdetail->residenceNo;
                                    $ebi = $empdetail->budgetIncrement;
                                    $eg = $empdetail->gender;
                                    
                                    $ebn = $empdetail->bankName;
                                    $eba = $empdetail->bankAccount;
                                    $ebg = $empdetail->bloodGroup;

                                    $ee = $empdetail->email;
                                    $ea1 = $empdetail->address1;
                                    $ea2 = $empdetail->address2;
                                   
                                    $ea3 = $empdetail->address3;
                                    $enok = $empdetail->nextOfKin;
                                    $enokn = $empdetail->nextOfKincontactNo;
                                    
                                    $eimg = $empdetail->empImage;
                                    $edes = $empdetail->designation;
                                    $edip = $empdetail->DepId;
              
                                    echo "<div>";
                                    echo "<table border='1' align='center' class='t'>";
                                    echo "<tr>";
                                    echo "<td>empId</td>";
                                    echo "<td><input type='text' id='ei' name='ei' value='";
                                    echo $ei;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>title</td>";
                                    echo "<td><input type='text' id='et' name='et' value='";
                                    echo $et;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>nameWithInitials</td>";
                                    echo "<td><input type='text' id='enwi' name='enwi' value='";
                                    echo $enwi;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>fullName</td>";
                                    echo "<td><input type='text' id='efn' name='efn' value='";
                                    echo $efn;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>callName</td>";
                                    echo "<td><input type='text' id='ecn' name='ecn' value='";
                                    echo $ecn;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>nic</td>";
                                    echo "<td><input type='text' id='enic' name='enic' value='";
                                    echo $enic;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>dob</td>";
                                    echo "<td><input type='date' id='edob' name='edob' value='";
                                    echo $edob;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>civilStatus</td>";
                                    echo "<td><input type='text' id='ecs' name='ecs' value='";
                                    echo $ecs;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>district</td>";
                                    echo "<td><input type='text' id='ed' name='ed' value='";
                                    echo $ed;
                                    echo "' ></td>";
                                    echo "</tr>";

                                    echo "<tr>";
                                    echo "<td>gsDivision</td>";
                                    echo "<td><input type='text' id='egd' name='egd' value='";
                                    echo $egd;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>payType</td>";
                                    echo "<td><input type='text' id='ept' name='ept' value='";
                                    echo $ept;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>mobileNo</td>";
                                    echo "<td><input type='text' id='emn' name='emn' value='";
                                    echo $emn;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>residenceNo</td>";
                                    echo "<td><input type='text' id='ern' name='ern' value='";
                                    echo $ern;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>budgetIncrement</td>";
                                    echo "<td><input type='text' id='ebi' name='ebi' value='";
                                    echo $ebi;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>gender</td>";
                                    echo "<td><input type='text' id='eg' name='eg' value='";
                                    echo $eg;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>bankName</td>";
                                    echo "<td><input type='text' id='ebn' name='ebn' value='";
                                    echo $ebn;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>bankAccount</td>";
                                    echo "<td><input type='text' id='eba' name='eba' value='";
                                    echo $eba;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>bloodGroup</td>";
                                    echo "<td><input type='text' id='ebg' name='ebg' value='";
                                    echo $ebg;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<tr>";
                                    echo "<td>email</td>";
                                    echo "<td><input type='text' id='ee' name='ee' value='";
                                    echo $ee;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>address1</td>";
                                    echo "<td><input type='text' id='ea1' name='ea1' value='";
                                    echo $ea1;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>address2</td>";
                                    echo "<td><input type='text' id='ea2' name='ea2' value='";
                                    echo $ea2;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>address3</td>";
                                    echo "<td><input type='text' id='ea3' name='ea3' value='";
                                    echo $ea3;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>nextOfKin</td>";
                                    echo "<td><input type='text' id='enok' name='enok' value='";
                                    echo $enok;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>nextOfKincontactNo</td>";
                                    echo "<td><input type='text' id='enokn' name='enokn' value='";
                                    echo $enokn;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>empImage</td>";
                                    echo "<td><input type='file' id='eimg' name='eimg' value='";
                                    echo $eimg;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>designation</td>";
                                    echo "<td><input type='text' id='edes' name='edes' value='";
                                    echo $edes;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>DepId</td>";
                                    echo "<td><input type='text' id='edip' name='edip' value='";
                                    echo $edip;
                                    echo "' ></td>";
                                    echo "</tr>";
                                    echo "</table>";   
    ...
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            //change password
             ...
             $ea3 = Input::get('ea3');
             $enok = Input::get('enok');
             $enokn = Input::get('enokn');

             $eimg = Input::get('eimg');
             $edes = Input::get('edes');
             $edip = Input::get('edip');

             $employeeup = DB::getInstance()->query("UPDATE employee SET 
                title='$et', 
                nameWithInitials = '$enwi',
                fullName = '$efn',
                callName = '$ecn',
                nic = '$enic',
                dob = '$edob',
