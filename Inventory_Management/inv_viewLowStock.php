                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon ti ti-face-sad"></i>&nbsp; Low Stock</strong>
                        </div>
                        <div class="card-body">
...
if(!$lowItems->count()) {
    ...
    foreach ($lowItems->results() as $lowItems) {
        ...
        echo "</td>";                             
        echo "<td>";
        echo "<a href='inv_updateLowStock.php?id=$lowItems->item_id ' class='btn btn-outline-success btn-sm'><i class='fa fa-plus'></i>&nbsp; Update &nbsp</a>";
        echo "</td>";
        echo "</tr>";
    }
}
