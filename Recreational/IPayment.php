...
if(Input::exists()){
  ...
  if($validation->passed()){
      $payment = new Residentialpayment();
      try{

        $payment->create('payment',array(
            'reservationType' => Input::get('reservationType'),
...
<body>
    ...
    <center><h2><b>In-house customers Payments</b></h2></center>
...
<div class="container">
   <form action="" method="post" class="form-horizontal">
    ...
    <!--<div class="row">
      <div class="col-25">
        <label for="lname">Reservation ID</label>
      </div>
      <div class="col-75">
        <input type="text" id="RID" name="ReservationID" placeholder="Enter Reservation ID..">
      </div>
    </div>-->
