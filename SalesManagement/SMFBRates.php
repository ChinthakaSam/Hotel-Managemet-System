...
include 'database.php';  
 ...
 {  
      $insert_data = array(  
         'customerType'     =>     mysqli_real_escape_string($data->con, $_POST['customerType']),  
           ...
           'deluxeFBRate'     =>     mysqli_real_escape_string($data->con, $_POST['deluxeFBRate']),  
           'executiveFBRate'          =>     mysqli_real_escape_string($data->con, $_POST['executiveFBRate']),
          'presidentialFBRate'          =>     mysqli_real_escape_string($data->con, $_POST['presidentialFBRate'])
      );  
 ...
 {  
      ...
      {  
           header("location:SMFBRates.php?updated=1");  
      }  
 }  
           ...
           <div class="container" style="width:700px;">  
                <form method="post">  
                     ...
                     ?>  
                          ...
                          <br /> 
                        <label>Delux FB Rate</label>  
                          <input type="text" name="deluxeFBRate" value="<?php echo $post["deluxeFBRate"]; ?>" class="form-control" />  
                          <br /> 
                        <label>Executive FB Rate</label>  
                          <input type="text" name="executiveFBRate" value="<?php echo $post["executiveFBRate"]; ?>" class="form-control" />  
                          <br /> 
                        <label>Presidential FB Rate</label>  
                          <input type="text" name="presidentialFBRate" value="<?php echo $post["presidentialFBRate"]; ?>" class="form-control" />  
                          <br /> 
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered" border="1">  
                          <tr>  
                               ...
                               <td width="30%">Date</td>  
                               <td width="10%">Delux FB Rate</td>  
                               <td width="10%">Executive FB Rate</td>  
                               <td width="10%">Presidential FB Rate</td>
                              <td width="10%">Edit</td>
                          </tr>  
                          <?php  
                          ...
                          <tr>  
                              ...
                              <td><?php echo $post["deluxeFBRate"]; ?></td>
                              <td><?php echo $post["executiveFBRate"]; ?></td>
                              <td><?php echo $post["presidentialFBRate"]; ?></td>
