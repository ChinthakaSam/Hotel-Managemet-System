     ...
     <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add New Suppliers</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <strong><i class="fa fa-plus"></i>&nbsp; Add New Suppilers</strong>
            </div>
        ...
        <?php
                                    ...
                                    echo "Nirmani Printers & Publishers";
                                    ...
                                    echo "Mrs. Niramni Paranavitharana";
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='phone' name='phone' autocomplete='off' value='";
                                    echo "0112968611";
