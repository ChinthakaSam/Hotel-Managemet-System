    ...
    <div id="right-panel" class="right-panel">
     ...
     <div class="breadcrumbs">
        ...
        <?php
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='total_price' name='total_price' readonly='' class='form-control'></div></div>";
                            
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='email-input' class=' form-control-label'>Arrival Date</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='date' id='supply_date' name='supply_date' value='' class='form-control'><small class='form-text text-muted'>Please enter arrival date</small></div></div>";
