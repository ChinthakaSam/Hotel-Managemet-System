            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title"></h3><!-- /.menu-title -->
                     <li class="active">
                        <a href="personalView.php?tab=dashboard"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title"></h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Personal Details</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="personalView.php?tab=myProfile">My Profile</a></li>
                            <li><a href="personalView.php?tab=changePassword">Change Password</a></li>
                            <li><a href="personalView.php?tab=applyLeave">Apply Leave</a></li>
