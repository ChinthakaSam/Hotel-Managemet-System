     ...
     <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Discard Item</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <strong><i class="fa fa-trash-o"></i>&nbsp; Discard Item</strong>
            </div>
         ...
         $ab = Input::get('id');
                ...
                if(!$upstock->count()) {
                                ...
                                foreach ($upstock->results() as $upstock) {
                                    ...
                                    $cId = $upstock -> cId;
                                    $dep = DB::getInstance()->query("SELECT * FROM inv_category WHERE cId = $cId");
                                        if(!$dep->count()) {
                                            echo 'No user';
                                        } else {
                                    ...
                                    $sup_Id = $upstock -> sup_Id;
                                    $deps = DB::getInstance()->query("SELECT * FROM inv_supplier WHERE sup_Id = $sup_Id");
                                        if(!$deps->count()) {
                                            echo 'No user';
                                        } else {
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='item_name' name='item_name' readonly='' autocomplete='off' value='";
                                    echo $item_name;
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='quantity' name='quantity' autocomplete='off' value='";
                                    echo $quantity;
                                    echo "' class='form-control'><small class='form-text text-muted'>You can set discarding quantity.</small></div></div>";

                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='select' class=' form-control-label'>Select Measuring Unit</label></div>";
                                    echo "<div class='col-12 col-md-9'>";
                                    echo "<select name='measuring_unit' readonly='' id='measuring_unit' class='form-control'>";
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='price_per_unit' name='price_per_unit' readonly='' autocomplete='off' value='";
                                    echo $price_per_unit;
                                    echo "' class='form-control'></div></div>";
                            
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='email-input' class=' form-control-label'>Arrival Date</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='date' id='supply_date' name='supply_date' readonly='' value='";
                                    echo $supply_date;
                                    echo "' class='form-control'></div></div>";
                            
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='email-input' class=' form-control-label'>Expiry Date (OPTIONAL) </label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='date' id='expiry_date' name='expiry_date' readonly='' value='";
                                    echo $expiry_date;
                                    echo "' class='form-control'></div></div>";

                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='select' class=' form-control-label'>Reason for discarding</label></div>";
                                    echo "<div class='col-12 col-md-9'>";
                                    echo "<select name='reason' id='reason' class='form-control'>";
                                     echo "<option value='0'>Please select Reason</option>";
                                    ...
                                    echo "<div class='col-12 col-md-9'>";
                                    echo "<select name='cIds' id='cIds' readonly='' class='form-control'>";
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='cId_input' name='cId_input' value='";
                                    echo $cId;
                                    ...
                                    echo "<div class='col-12 col-md-9'>";
                                    echo "<select name='sup_Ids' id='sup_Ids' readonly='' class='form-control'>";
                                                    echo "<option value='$supss'>";
                                                    echo $supss;
                                                    echo "</option>";
                                    echo "</select></div></div>";
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='sup_Id_input' name='sup_Id_input' value='";
                                    echo $sup_Id;
                                    echo "' readonly='' class='form-control'></div></div>";
    ...
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            ...
            if($ab == 'Expired'){
                ...
                $u = Input::get('id');
                $newuser = DB::getInstance()->query("SELECT item_id FROM inv_recieved_items WHERE item_id =$u");
                if(!$newuser->count()) {
                               ...
                               foreach ($newuser->results() as $newuser) {
                                    ...
                                    $x = $newuser->item_id;
                                  $userdl = DB::getInstance()->delete('inv_recieved_items', array('item_id', '=', $x));
                                  if(!$userdl->count()) {
                                     ...
                                     echo '<br><br><div class="sufee-alert alert with-close alert-primary alert-dismissible fade show" style="width:350px;margin-left:38%;">
                                                <span class="badge badge-pill badge-primary">Success</span>
                                                    Item(s) has been discarded Successfully!
                                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                           </div>';
                ...
                $catup = DB::getInstance()->query("UPDATE inv_recieved_items SET  quantity = '$newqunt' WHERE item_id='$item_id'");
            ...
            $inventory2->create('inv_discard',array(
                'item_name' => $item_names,
                'quantity' => $quantityx,
                'measuring_unit' => $measuring_unit,
                'supply_date' => $supply_date,
                'expiry_date' => $expiry_date,
                'discarded_date' => $discarding_date,
                'reason' => $ab,
                'cId' => $cId,
                'sup_Id' => $sup_Id
            ));
...
?>
        ...
        <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-dot-circle-o"></i> Discard Item
                    </button>
   ...
   <?php
                ...
                switch($tb) { //switch is just like a bunch of if()s
                    ...
                    break;  //break, witch means stop
                    case 'POrderReportt': // page4, if changePage has the value of page3
