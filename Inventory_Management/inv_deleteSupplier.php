     ...
     <div class="breadcrumbs">
        ...
        <div class="card">
            <div class="card-header">
                <strong><i class="fa fa-trash-o"></i>&nbsp; Delete Supplier</strong>
            </div>
        ...
        <?php
         ...
         $d = Input::get('id');
                $upsupl = DB::getInstance()->query("SELECT * FROM inv_supplier WHERE sup_Id ='$d'");
                if(!$upsupl->count()) {
                                  echo '<br><div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" style="width:400px;margin-left:38%;">
                                                ...
                                                Supplier not selected, Please select a Supplier for deletion!
                                ...
                                foreach ($upsupl->results() as $ups) {
                                    ...
                                    echo $name;
                                    echo "' class='form-control' disabled=''></div></div>";
                                    ...
                                    echo "<select name='supplying_category' id='supplying_category' class='form-control' disabled=''>";
...
if(Input::exists()){
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            $u = Input::get('id');
                $newuser = DB::getInstance()->query("SELECT sup_Id FROM inv_supplier WHERE sup_Id =$u");
                if(!$newuser->count()) {
                                ...
                                foreach ($newuser->results() as $newuser) {
                                    ...
                                    $x = $newuser->sup_Id;
                                  $userdl = DB::getInstance()->delete('inv_supplier', array('sup_Id', '=', $x));
                                  if(!$userdl->count()) {
    ...
    <br><br>
        ...
        <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
                <div class="card-footer">
                                ...
                                Are you sure you want to delete this category? Once you confiremd, this data will no longer avaliable in the system.
                                </div>
                                <br>
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-dot-circle-o"></i> Delete Supplier
                    </button>
