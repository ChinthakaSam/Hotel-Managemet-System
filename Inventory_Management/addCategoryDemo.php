     ...
     <div class="breadcrumbs">
        ...
        <div class="card">
            <div class="card-header">
                <strong><i class="fa fa-plus"></i>&nbsp; Add New Category</strong>
            </div>
        ...
        <?php
                                    ...
                                    echo "Beds, Tables, Chairs, Decorations are in this category";
                                    echo "</textarea></div>";
    ...
    'description' => array(
      ...
      try{
        ...
        $inventory->create('inv_category',array(
            ...
            echo "<br><div class='sufee-alert alert with-close alert-success alert-dismissible fade show'>
                                            <span class='badge badge-pill badge-success'>Success</span>&nbsp &nbsp
