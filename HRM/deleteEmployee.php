...
if(!$employee->count()) {
    ...
    foreach ($employee->results() as $employee) {
        ...
        echo "</td>";
         echo "<td>";
            echo $employee->budgetIncrement;
        echo "</td>";
        echo "<td>";
            echo $employee->gender;
        echo "</td>";
        echo "<td>";
            echo $employee->bankName;
        echo "</td>";
         echo "<td>";
            echo $employee->bankAccount;
        echo "</td>";
        echo "<td>";
        ...
        echo "</td>";
         echo "<td>";
            echo $employee->nextOfKin;
        echo "</td>";
        echo "<td>";
            echo $employee->nextOfKincontactNo;
        echo "</td>";
        echo "<td>";
        ...
        echo "</td>";
        echo "<td>";
        echo "<a href='deleteEmployeeProceed.php?id=$employee->empId' class='btn btn-outline-success btn-sm'><i class='fa fa-edit (alias)'></i>&nbsp;Delete</a>";
        echo "</td>";
        echo "</tr>";
    }
}
