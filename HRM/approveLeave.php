...
$leave = DB::getInstance()->query("SELECT * FROM employeeleave WHERE MONTH(startDate)=MONTH(CURDATE()) AND YEAR(startDate)=YEAR(CURDATE()) AND status = 'Pending' AND depId =$did");
?>
...
?>
    ...
    <!-- Right Panel -->
    <?php
$leave1 = DB::getInstance()->query("SELECT * FROM employeeleave WHERE MONTH(startDate)=MONTH(CURDATE())+1 AND YEAR(startDate)=YEAR(CURDATE()) AND status = 'Pending' AND depId =$did");
?>
...
if(!$leave1->count()) {
    ...
    foreach ($leave1->results() as $leave1) {
        echo "<tr>";
        echo "<td>";
            echo $leave1->empLeaveId;
        echo "</td>";
        echo "<td>";
            echo $leave1->startDate;
        echo "</td>";
         echo "<td>";
            echo $leave1->endDate;
        echo "</td>";
