...
<?php
$training = DB::getInstance()->query("SELECT * FROM trainingsession");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-sitemap"></i>&nbsp; Training Sessions</strong>
                        </div>
                        <div class="card-body">
...
if(!$training->count()) {
    ...
    foreach ($training->results() as $training) {
        ...
        echo "</td>";
        echo "<td>";
            echo $training->tsName;
        echo "</td>";
         echo "<td>";
            echo $training->tsConductedBy;
        echo "</td>";
        echo "<td>";
            echo $training->tsDescription;
        echo "</td>";
         echo "<td>";
            echo $training->noTrainees;
        echo "</td>";
        echo "<td>";
            echo $training->created_date;
        echo "</td>";
        echo "<td>";
        echo "<a href='deleteTrainingProceed.php?id=$training->tsId' class='btn btn-outline-success btn-sm'><i class='fa fa-edit (alias)'></i>&nbsp; Delete</a>";
        echo "</td>";
        echo "</tr>";
    }
}
