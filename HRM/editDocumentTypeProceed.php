    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card">
            <div class="card-header">
                <strong>Edit Document Types</strong>
            </div>
...
if(Input::exists()){
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            //change password
             $dtid = Input::get('dtid');
             $dtname = Input::get('dtname');
        
             $doctypeup = DB::getInstance()->query("UPDATE documenttype SET docTypeName='$dtname' WHERE docTypeId ='$dtid'");
