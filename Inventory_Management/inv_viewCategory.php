...
<?php
$category = DB::getInstance()->query("SELECT * FROM inv_category");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-sitemap"></i>&nbsp; Categories</strong>
                        </div>
                        <div class="card-body">
...
if(!$category->count()) {
    ...
    foreach ($category->results() as $category) {
        ...
        echo "</td>";
        echo "<td>";
        echo "<a href='inv_updateCategory.php?id=$category->cId' class='btn btn-outline-success btn-sm'><i class='fa fa-edit (alias)'></i>&nbsp; Edit &nbsp &nbsp &nbsp</a>";
        echo "&nbsp";
        echo "&nbsp";
        echo "<br>";
        echo "<a href='inv_deleteCategory.php?id=$category->cId' class='btn btn-outline-danger btn-sm'><i class='fa fa-trash-o'></i>&nbsp; Delete &nbsp</a>";
        echo "</td>";
        echo "</tr>";
    }
}
