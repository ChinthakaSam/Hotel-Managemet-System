                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                      <div class="card-header">
                        <strong><i class="fa fa-file-text-o"></i>&nbsp; Report of Purchase Orders</strong>
                      </div>
                     
                      <form id="data_form" action="POrderPdf.php" method="GET" target="_blank" class="form-horizontal">
