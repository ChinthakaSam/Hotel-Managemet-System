            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="hrView.php?tab=allowance1">Alllowance 1</a></li>
                             <li><i class="fa fa-puzzle-piece"></i><a href="hrView.php?tab=allowance2">Alllowance 2</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Allowance 2</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="tables-data.html">Data  </a></li>
                        </ul>
                    </li>
