    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card">
            <div class="card-header">
                <strong>Delete Designation</strong>
            </div>
...
if(Input::exists()){
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            //change password
                $u = Input::get('id');
                $newuser = DB::getInstance()->query("SELECT desId FROM designation WHERE desId =$u");
                if(!$newuser->count()) {
                                ...
                                foreach ($newuser->results() as $newuser) {
                                    ...
                                    $x = $newuser->desId;
                                  $userdl = DB::getInstance()->delete('designation', array('desId', '=', $x));
             ...
             <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
                <div class="card-footer" align="right">
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-dot-circle-o"></i> Delete Designation
                    </button>
                </div>
            </form>
        </div>
