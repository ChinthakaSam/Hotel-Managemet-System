...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    </li><h3 class="menu-title"></h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="hrManagerView.php?tab=EmployeeGenderReport">Gender Report</a></li>
                            <li><a href="hrManagerView.php?tab=Report">Report</a></li>
                            <li><a href="hrManagerView.php?tab=deleteEvent">Delete Event</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <?php
                ...
                switch($tb) { //switch is just like a bunch of if()s
                    ...
                    include('viewEmployee.php'); //include page.html
                    ...
                    case 'EmployeeGenderReport': // page2, if changePage has the value of page2
                    include('EmployeeGenderReport.php'); //include page2.html
                    break;  //break, witch means stop
                    case 'Report': // page2, if changePage has the value of page2
                    include('Report.php'); //include page2.html
                    break;  //break, witch means stop
                } //end the switch
            ?> 
