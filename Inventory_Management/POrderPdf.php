...
class pdf extends TCPDF
{
	...
	public function Header(){
		...
		$this->Ln(2);
		$this->SetFont('helvetica', 'B', 15);
		$this->Cell(189,15, 'Report of Purchase Orders', 0,1,'C');
		$this->Ln(10);

		$this->SetFont('times','B',9);
		$this->SetFillColor(224,235,255);
		$this->Cell(40,5,'Item Name',1,0,'C',1);
		$this->Cell(15,5,'Quantity',1,0,'C',1);
		$this->Cell(22,5,'Measuring Unit',1,0,'C',1);
		$this->Cell(20,5,'Ordered Date',1,0,'C',1);
		$this->Cell(15,5,'Total Price',1,0,'C',1);
		$this->Cell(15,5,'Status',1,0,'C',1);
		$this->Cell(50,5,'Supplier',1,0,'C',1);
		...
		$dep = DB::getInstance()->query("SELECT * FROM inv_orderd_items WHERE order_date BETWEEN '$sdate' AND '$edate'");
                                        foreach ($dep->results() as $dep) {
                                        	...
                                        	$this->Ln(5);
											$this->Cell(40,5,$a,1,0,'C',1);
											$this->Cell(15,5,$b,1,0,'C',1);
											$this->Cell(22,5,$c,1,0,'C',1);
											$this->Cell(20,5,$d,1,0,'C',1);
											$this->Cell(15,5,$g,1,0,'C',1);
											$this->Cell(15,5,$h,1,0,'C',1);
											$this->Cell(50,5,$f,1,0,'C',1);
		...
		$this->Cell(50,5,'Report of Purchase Orders between',0,0,'C');
