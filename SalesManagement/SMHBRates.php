...
include 'database.php';  
 ...
 {  
      $insert_data = array(  
         'customerType'     =>     mysqli_real_escape_string($data->con, $_POST['customerType']),  
           ...
           'deluxeHBRate'     =>     mysqli_real_escape_string($data->con, $_POST['deluxeHBRate']),  
           'executiveHBRate'          =>     mysqli_real_escape_string($data->con, $_POST['executiveHBRate']),
          'presidentialHBRate'          =>     mysqli_real_escape_string($data->con, $_POST['presidentialHBRate'])
      );  
 ...
 {  
      ...
      {  
           header("location:SMHBRates.php?updated=1");  
      }  
 }  
           ...
           <div class="container" style="width:700px;">  
                <form method="post">  
                     ...
                     ?>  
                          ...
                          <br /> 
                        <label>Delux HB Rate</label>  
                          <input type="text" name="deluxeHBRate" value="<?php echo $post["deluxeHBRate"]; ?>" class="form-control" />  
                          <br /> 
                        <label>Executive HB Rate</label>  
                          <input type="text" name="executiveHBRate" value="<?php echo $post["executiveHBRate"]; ?>" class="form-control" />  
                          <br /> 
                        <label>Presidential HB Rate</label>  
                          <input type="text" name="presidentialHBRate" value="<?php echo $post["presidentialHBRate"]; ?>" class="form-control" />  
                          <br /> 
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          <tr>  
                               ...
                               <td width="30%">Date</td>  
                               <td width="10%">Delux HB Rate</td>  
                               <td width="10%">Executive HB Rate</td>  
                               <td width="10%">Presidential HB Rate</td>
                              <td width="10%">Edit</td>
                          </tr>  
                          <?php  
                          ...
                          <tr>  
                              ...
                              <td><?php echo $post["deluxeHBRate"]; ?></td>
                              <td><?php echo $post["executiveHBRate"]; ?></td>
                              <td><?php echo $post["presidentialHBRate"]; ?></td>
