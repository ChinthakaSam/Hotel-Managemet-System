    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="welcome.php"><img src="../images/logonew.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="welcome.php"><img src="../images/logo2new.png" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="adminView.php?tab=addUser">Add User</a></li>
                            <li><a href="adminView.php?tab=deleteUser">Delete User</a></li>
                            <li><a href="adminView.php?tab=resetPassword">Reset Password</a></li>
                            <li><a href="adminView.php?tab=viewUser">View User</a></li>
                        </ul>
                    </li> 
                     <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa  fa-trophy"></i>Leave Type Management</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="adminView.php?tab=addLeaveType">Add Leave Type</a></li>
                            <li><a href="adminView.php?tab=deleteLeaveType">Delete Leave Type</a></li>
                            <li><a href="adminView.php?tab=editLeaveType">Update Leave Type</a></li>
                        </ul>
                    </li> 
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card">
            <div class="card-header">
                <strong>Delete Leave Type</strong>
            </div>
        ...
        <?php
            ...
            $id = Input::get('id');
                ...
                $department = DB::getInstance()->query("SELECT * FROM leavetype WHERE leaveTypeId ='$id'");
                if(!$department->count()) {
                                
                             } else {
                                foreach ($department->results() as $department) {
                  
                                    $dd = $department->leaveTypeId;
                                    $ddn = $department->leaveTypeName;
                                    $ddd = $department->maxDays;
...
if(Input::exists()){
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            //change password
                $u = Input::get('id');
                $newuser = DB::getInstance()->query("SELECT leaveTypeId FROM leavetype WHERE leaveTypeId =$u");
                if(!$newuser->count()) {
                                
                             } else {
                                foreach ($newuser->results() as $newuser) {
                  
                                    $x = $newuser->leaveTypeId;
                                  $userdl = DB::getInstance()->delete('leavetype', array('leaveTypeId', '=', $x));
                                  if(!$userdl->count()) {
             ...
             <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
                <div class="card-footer" align="right">
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-dot-circle-o"></i> Delete Leave Type
                    </button>
                </div>
            </form>
        </div>
