    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card">
            <div class="card-header">
                <strong>Delete Training Session</strong>
            </div>
        ...
        <?php
          ...
          $id = Input::get('id');
                ...
                $training = DB::getInstance()->query("SELECT * FROM trainingsession WHERE tsId ='$id'");
                if(!$training->count()) {
                                ...
                                foreach ($training->results() as $training) {
                                    ...
                                    $ti = $training->tsId;
                                    $tn = $training->tsName;
                                    $tcb = $training->tsConductedBy;
                                    $td = $training->tsDescription;
                                    $tno = $training->noTrainees;
                                    $tcd = $training->created_date;
                        
                                    echo "<div>";
                                    echo "<table border='1' align='center' class='t'>";
                                    echo "<tr>";
                                    echo "<td>ID</td>";
                                    echo "<td><input type='text' id='tid' name='tid' value='";
                                    echo $ti;
                                    echo "' readonly></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td>Session Name</td>";
                                    echo "<td><input type='text' id='tname' name='tname' value='";
                                    echo $tn;
                                    echo "'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Lecturer</td>";
                                    echo "<td><input type='text' id='tcby' name='tcby' value='";
                                    echo $tcb;
                                    echo "'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Description</td>";
                                    echo "<td><input type='text' id='tdes' name='tdes' value='";
                                    echo $td;
                                    echo "'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Number of Trainees</td>";
                                    echo "<td><input type='text' id='tnum' name='tnum' value='";
                                    echo $tno;
                                    echo "'/></td>";
                                    echo "</tr>";
                                     echo "<tr>";
                                    echo "<td>Created Date</td>";
                                    echo "<td><input type='text' id='tcdt' name='tcdt' value='";
                                    echo $tcd;
                                    echo "' readonly></td>";
                                    echo "</tr>";
                                    echo "</table>";   
...
if(Input::exists()){
    if(Token::check(Input::get('token'))){
        ...
        if($validation->passed()){
            //change password
                $u = Input::get('id');
                $newuser = DB::getInstance()->query("SELECT tsId FROM trainingsession WHERE tsId =$u");
                if(!$newuser->count()) {
                                ...
                                foreach ($newuser->results() as $newuser) {
                                    ...
                                    $x = $newuser->tsId;
                                  $userdl = DB::getInstance()->delete('trainingsession', array('tsId', '=', $x));
                                     ...
                                     echo '  <br><br><div class="sufee-alert alert with-close alert-primary alert-dismissible fade show" style="width:350px;margin-left:38%;">
                                                <span class="badge badge-pill badge-primary">Success</span>
                                                    Training session has been deleted Successfully!
             ...
             <input type="hidden" name="token" value="<?php echo Token::generate(); ?>">
                <div class="card-footer" align="right">
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-dot-circle-o"></i> Delete Session
                    </button>
                </div>
            </form>
        </div>
