...
$el = DB::getInstance()->query("SELECT * FROM employeeleave WHERE requestedBy = $eid AND MONTH(startDate)=6 AND YEAR(startDate)=YEAR(CURDATE())");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-sitemap"></i>&nbsp;June Leave History</strong>
                        </div>
                        <div class="card-body">
