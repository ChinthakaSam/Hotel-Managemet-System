     ...
     <div class="breadcrumbs">
        ...
        <div class="card">
            <div class="card-header">
                <strong><i class="fa fa-edit (alias)"></i>&nbsp; Update Suppilers</strong>
            </div>
        ...
        <?php
         ...
         $b = Input::get('id');
                $upsupl = DB::getInstance()->query("SELECT * FROM inv_supplier WHERE sup_Id ='$b'");
                if(!$upsupl->count()) {
                                ...
                                foreach ($upsupl->results() as $ups) {
                                    
                                    $sup_Id = $ups -> sup_Id;
                                    $name = $ups -> name;
                                    $address = $ups -> address;
                                    $contact_person = $ups -> contact_person;
                                    $phone = $ups -> phone;
                                    $email = $ups -> email;

                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='text-input' class='form-control-label'>Supplier's Name</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='text' id='name' name='name' autocomplete='off' value='";
                                    echo $name;
                                    echo "' class='form-control'><small class='form-text text-muted'>Please enter supplier's name </small></div></div>";
                          
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='text-input' class='form-control-label'>Supplier's Address</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='text' id='address' name='address' autocomplete='off' value='";
                                    echo $address;
                                    echo "' class='form-control'><small class='form-text text-muted'>Please enter supplier's address </small></div></div>";
                            
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='text-input' class=' form-control-label'>Contact Person</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='text' id='contact_person' name='contact_person' autocomplete='off' value='";
                                    echo $contact_person;
                                    echo "' class='form-control'><small class='form-text text-muted'>Please enter the Name of a contact person </small></div></div>";

                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='email-input' class='' form-control-label'>Contact Number</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='text' id='phone' name='phone' autocomplete='off' value='0";
                                    echo $phone;
                                    echo "' class='form-control'><small class='form-text text-muted'>Please enter Supplier's contact number</small></div></div>";
                          
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='email-input' class=' form-control-label'>Email</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='email' id='email' name='email' autocomplete='off' value='";
                                    echo $email;
                                    echo "' class='form-control'><small class='form-text text-muted'>Please enter supplier's email</small></div></div>";

                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='select' class=' form-control-label'>Supplying Category</label></div>";
                                    echo "<div class='col-12 col-md-9'>";
                                    echo "<select name='supplying_category' id='supplying_category' class='form-control'>";
                                    ...
                                    echo "<div class='col-12 col-md-9'><input type='text' id='cId' name='cId' value='' readonly=''";
      ...
      'required' => true)
        ...
        if($validation->passed()){
            ...
            $cId = Input::get('cId');
                    ...
                    $catup = DB::getInstance()->query("UPDATE inv_supplier SET name='$name', address = '$address', contact_person='$contact_person', phone='$phone', email='$email', cId='$cId' WHERE sup_Id='$sup_Id'");
