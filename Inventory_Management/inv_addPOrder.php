     ...
     <div class="breadcrumbs">
        ...
        <div class="card">
            <div class="card-header">
                <strong><i class="fa fa-edit (alias)"></i>&nbsp; Add Purchase Order </strong>
            </div>
         ...
         $ab = Input::get('id');
                ...
                if(!$upstock->count()) {
                                ...
                                foreach ($upstock->results() as $upstock) {
                                    ...
                                    echo $price_per_unit;
                                    echo "' class='form-control'><small class='form-text text-muted'>Please enter unit price.</small></div></div>";
                            
                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='text-input' class=' form-control-label'>Total Price</label></div>";
                                    echo "<div class='col-12 col-md-9'><input type='text' id='total_price' name='total_price' readonly='' autocomplete='off' value='' class='form-control'></div></div>";

                                    echo "<div class='row form-group'>";
                                    echo "<div class='col col-md-3'><label for='select' class=' form-control-label'>Set Status</label></div>";
                                    echo "<div class='col-12 col-md-9'>";
                                    echo "<select name='status' id='status' class='form-control'>";
                                    echo "<option value='0'>Please set state</option>";
