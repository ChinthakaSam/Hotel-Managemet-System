                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Goods Issuing Report</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                      <div class="card-header">
                        <strong><i class="fa fa-file-text-o"></i>&nbsp; Report of Issued Goods</strong>
                      </div>
                     
                      <form id="data_form" action="issuePdf.php" method="GET" target="_blank" class="form-horizontal">
