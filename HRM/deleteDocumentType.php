...
<?php
$doctype = DB::getInstance()->query("SELECT * FROM documenttype");
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-sitemap"></i>&nbsp; Document Types</strong>
                        </div>
                        <div class="card-body">
...
if(!$doctype->count()) {
    ...
    foreach ($doctype->results() as $doctype) {
        echo "<tr>";
        echo "<td>";
            echo $doctype->docTypeId;
        echo "</td>";
        echo "<td>";
            echo $doctype->docTypeName;
        echo "</td>";
        echo "<td>";
        echo "<a href='deleteDocumentTypeProceed.php?id=$doctype->docTypeId' class='btn btn-outline-success btn-sm'><i class='fa fa-edit (alias)'></i>&nbsp; Delete</a>";
        echo "</td>";
        echo "</tr>";
    }
}
