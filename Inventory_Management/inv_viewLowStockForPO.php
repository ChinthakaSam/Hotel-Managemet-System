                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Items to be Ordered</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<?php
$lowItems = DB::getInstance()->get('inv_recieved_items', array('quantity', '<=', '10'));
?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><i class="menu-icon fa fa-archive"></i>&nbsp; Items to be Ordered</strong>
                        </div>
                        <div class="card-body">
...
if(!$lowItems->count()) {
    ...
    foreach ($lowItems->results() as $lowItems) {
        echo "<tr>";
        echo "<td>";
            echo $lowItems->item_id;
        echo "</td>";
        echo "<td>";
            echo $lowItems->item_name;
        echo "</td>";
        echo "<td>";
            echo $lowItems->quantity;
        echo "</td>";
        echo "<td>";
            echo $lowItems->measuring_unit;
        echo "</td>";
        echo "<td>";
            echo $lowItems->price_per_unit;
        echo "</td>";
        echo "<td>";
            echo $lowItems->supply_date;
        echo "</td>";
        echo "<td>";
            echo $lowItems->expiry_date;
        echo "</td>";
        echo "<td>";
            $cat = $lowItems->cId;
        ...
        echo "</td>";                             
        echo "<td>";
        echo "<a href='inv_addPOrder.php?id=$lowItems->item_id ' class='btn btn-outline-success btn-sm'><i class='fa fa-plus'></i>&nbsp; Add Order &nbsp</a>";
        echo "</td>";
        echo "</tr>";
    }
}
